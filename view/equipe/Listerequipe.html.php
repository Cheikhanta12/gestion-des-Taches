...
<a href="<?=WEB_ROUTE."?controller=equipeController&view=Listerequipe"?>" ></a>
        ...
        <?php  foreach ($equipe as $key => $value): ?>
                         ...
                         <td><?= $value["idP"] ?></td>
        <td>          
        <a href="<?=WEB_ROUTE.'?controller=equipeController&view=edit&idE='.$value['idE']?>" 
                                class="btn1">Modifier</a>
                                <a href="<?=WEB_ROUTE.'?controller=equipeController&view=deleted&idE='.$value['idE']?>" class="btn2">Supprimer</a>
                            </td>
                        </tr>
                        <?php endforeach;  ?>
                    </tbody>
            ...
            <ul class="pag">
                ...
                <li class="page"><a class="page-link" href="<?=WEB_ROUTE.'?controller=equipeController&view=Listerequipe&page='.$i?>">
                    <?= $i ?></a></li>
                <?php endfor;?>
            </ul>
        </nav>
